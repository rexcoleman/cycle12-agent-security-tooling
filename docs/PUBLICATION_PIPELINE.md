...
| 13 | validate_post.sh passes (R28) | All blog/research posts | Run `./validate_post.sh <post>` — 0 FAIL |
| 14 | Cross-posts generated and fresh (R29) | All distributed content | Check cross-posts/ timestamps vs source |
| 15 | Bio matches canonical copy (R30) | All published content | grep "at every layer of the stack" |
